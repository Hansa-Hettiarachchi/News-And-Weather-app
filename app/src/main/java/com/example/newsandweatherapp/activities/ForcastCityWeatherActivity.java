package com.example.newsandweatherapp.activities;
...
import com.example.newsandweatherapp.R;
import com.example.newsandweatherapp.model.forecastWeather;
import com.example.newsandweatherapp.utilities.Constants;
import com.example.newsandweatherapp.utilities.PreferenceManager;
...
public class ForcastCityWeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forcast_city_weather);
    ...
    private  void letsdoSomeNetworking(RequestParams params)
    {
        ...
        client.get(WEATHER_URL,params,new JsonHttpResponseHandler()
        {
            ...
            public void onSuccess(int statusCode, cz.msebera.android.httpclient.Header[] headers, JSONObject response) {
                ...
                Toast.makeText(ForcastCityWeatherActivity.this, "Data Get Success", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(int statusCode, cz.msebera.android.httpclient.Header[] headers, Throwable throwable, JSONObject errorResponse) {
                ...
                Toast.makeText(ForcastCityWeatherActivity.this, "Get data Failure", Toast.LENGTH_SHORT).show();
            }
        });
